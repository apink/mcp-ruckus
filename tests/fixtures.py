...
SAMPLE_WLANS_ZONE1 = [
    {"ssid": "Secure", "name": "Secure", "id": "wlan-001", "zoneId": "zone-001"},
    {"ssid": "Guest", "name": "Guest", "id": "wlan-002", "zoneId": "zone-001"},
    {"ssid": "IoT", "name": "IoT", "id": "wlan-003", "zoneId": "zone-001"},
]
...
SAMPLE_WLAN_DETAIL = {
    ...
    "authServiceOrProfile": {"name": "RADIUS"},
    ...
    "list": [
        {
            ...
            "severity": "Critical",
            "category": "AP",
            "activity": "AP AP-03-04@aa:bb:cc:11:44:04 is down",
        },
        {
            "id": "evt-002",
        ...
        },
        {
            ...
            "severity": "Warning",
            "category": "AP",
            "activity": "AP AP-01-02 channel 5GHz utilization 88% exceeds threshold",
        },
    ],
}
    ...
    "list": [
        {
            ...
            "detectedByAP": [
                {"apName": "AP-01-01", "rssi": "-65", "zoneName": "Campus", "mainDetector": True},
                {"apName": "AP-01-02", "rssi": "-78", "zoneName": "Campus", "mainDetector": False},
            ],
        }
    ],
}
...
SAMPLE_VLAN_SUMMARY = {
    ...
    "vlans": [
        ...
        {"id": 100, "name": "Users", "ports": 24},
        {"id": 200, "name": "Guest", "ports": 12},
    ],
}
...
SAMPLE_IP_ROUTES = {
    "total": 15,
    "routes": [
        {"destination": "0.0.0.0/0", "next_hop": "203.0.113.254", "type": "Static", "metric": 1},
        {"destination": "203.0.113.0/24", "next_hop": "direct", "type": "Connected", "metric": 0},
        {"destination": "198.51.100.0/24", "next_hop": "203.0.113.1", "type": "OSPF", "metric": 110},
    ],
}

SAMPLE_CONFIG = {
    "config": "hostname SW-DIST-01\n!\ninterface ethernet 1/1/1\n port-name Uplink to Core\n!\nend",
    "sha256": "abc123def456",
    "size_bytes": 2048,
    "line_count": 45,
}
