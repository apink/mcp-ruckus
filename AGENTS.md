...
FastMCP-based MCP server for Ruckus wireless (vSZ SmartZone) and switching (ICX) infrastructure. **85 MCP tools** (31 vSZ + 45 ICX + 6 inventory + 3 connectivity).
...
pytest tests/ -q          # 268 tests, 12 files
...
| `docs/TOOLS.md` | Complete 85-tool reference |
