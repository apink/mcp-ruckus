...
FastMCP-based MCP server for Ruckus wireless (vSZ SmartZone) and switching (ICX) infrastructure. **91 MCP tools** (32 vSZ + 50 ICX + 6 inventory + 3 connectivity).
...
pytest tests/ -q          # 369 tests, 20 files
...
| `docs/TOOLS.md` | Complete 91-tool reference |
